...
def exec_testcase_12():
    try:
        ...
        error_records_folder_name=rf'PO\models\RCA13\error_records\TESTCASE12\{timestamp}'
        ...
        shipcuststd_table = validate_data(general_logger,error_logger,'PO\models\RCA13\RCA13.json',0,None,False,12,error_records_folder_name)
        ...
        shipcustvar_table = validate_data(general_logger,error_logger,'PO\models\RCA13\RCA13.json',1,None,True,12,error_records_folder_name)
        if shipcuststd_table & shipcustvar_table:
            increment_count('pass_tc_count',general_logger,error_logger)

    except Exception as e:
        general_logger.info("Error executing Validation for TestCase - 12, check error log file for more details")
