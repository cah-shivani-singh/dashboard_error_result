...
def exec_testcase_15():
    try:
        ...
        error_records_folder_name=rf'PO\models\RCA13\error_records\TESTCASE15\{timestamp}'
        res = validate_data(general_logger,error_logger,'PO\models\RCA13\RCA13.json',0,None,True,15,error_records_folder_name)
        if res:
