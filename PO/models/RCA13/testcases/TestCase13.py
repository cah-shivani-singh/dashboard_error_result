...
def exec_testcase_13():
    try:
        ...
        error_records_folder_name=rf'PO\models\RCA13\error_records\TESTCASE13\{timestamp}'
        res = validate_data(general_logger,error_logger,'PO\models\RCA13\RCA13.json',0,None,True,13,error_records_folder_name)
        if res:
