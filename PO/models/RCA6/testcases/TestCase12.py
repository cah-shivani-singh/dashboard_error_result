...
def exec_testcase_12():
    try:
        ...
        error_records_folder_name=rf'PO\models\RCA6\error_records\TESTCASE12\{timestamp}'
        res = validate_data(general_logger,error_logger,'PO\models\RCA6\RCA6.json',0,None,True,12,error_records_folder_name)
        if res:
