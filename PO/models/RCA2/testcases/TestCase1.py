# testcase 6 and 7 will consume more gb around(233, 450 gbs respectively)
import sys
...
def exec_testcase_1():
    ...
    try:
        res=check_ddl_validation(general_logger,error_logger,rf'{json_path}',r'PO\models\RCA2\rca2_schema.csv',1)
