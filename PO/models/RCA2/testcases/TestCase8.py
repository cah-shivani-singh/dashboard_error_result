...
def exec_testcase_8():
    ...
    try:
        ...
        error_records_folder_name=rf'PO\models\RCA2\error_records\TESTCASE8\{timestamp}'

        centr_res = validate_data(general_logger,error_logger,'PO\models\RCA2\RCA2.json',0,'CENTRALIZED',False,8,error_records_folder_name)
        hubspk_res = validate_data(general_logger,error_logger,'PO\models\RCA2\RCA2.json',1,'HUBSPOKE',False,8,error_records_folder_name)
        non_centr = validate_data(general_logger,error_logger,'PO\models\RCA2\RCA2.json',2,'NON-CENTRALIZED',True,8,error_records_folder_name)
