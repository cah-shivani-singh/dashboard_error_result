...
def exec_testcase_7():
    ...
    try:
        ...
        error_records_folder_name=rf'PO\models\RCA2\error_records\TESTCASE7\{timestamp}'

        centr_res = validate_data(general_logger,error_logger,'PO\models\RCA2\RCA2.json',0,'CENTRALIZED',False,7,error_records_folder_name)
        hubspk_res = validate_data(general_logger,error_logger,'PO\models\RCA2\RCA2.json',1,'HUBSPOKE',False,7,error_records_folder_name)
        non_centr = validate_data(general_logger,error_logger,'PO\models\RCA2\RCA2.json',2,'NON-CENTRALIZED',True,7,error_records_folder_name)
