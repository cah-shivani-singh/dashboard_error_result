...
def exec_testcase_10():
    try:
        ...
        error_records_folder_name=rf'PO\models\RCA2\error_records\TESTCASE10\{timestamp}'
        res = validate_data(general_logger,error_logger,'PO\models\RCA2\RCA2.json',0,None,True,10,error_records_folder_name)
        if res:
