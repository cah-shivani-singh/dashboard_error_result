...
folder_path=rf'PO\models\RCA2\log_info\{timestamp}'
...
def collect_test_functions():
    ...
    for test_case_file in test_case_files:
        module_name = f'models.RCA2.testcases.{test_case_file[:-3]}'
        try:
...
if __name__ == "__main__":
    ...
    set_json_path(r'PO\\models\\RCA2\\RCA2.json',general_logger,error_logger)
    #write_config()
    run_all_test_cases()
