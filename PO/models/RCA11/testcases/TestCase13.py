...
def exec_testcase_13():
    try:
        ...
        error_records_folder_name=rf'PO\models\RCA11\error_records\TESTCASE13\{timestamp}'
        res = validate_data(general_logger,error_logger,'PO\models\RCA11\RCA11.json',0,None,True,13,error_records_folder_name)
        if res:
            increment_count('pass_tc_count',general_logger,error_logger)
        return res

    except Exception as e:
        general_logger.info("Error executing Validation for TestCase - 13, check error log file for more details")
