...
def exec_testcase_8():
    try:
        ...
        error_records_folder_name=rf'PO\models\RCA11\error_records\TESTCASE8\{timestamp}'
        general_logger.info("Validationg : LF_Short_code should not be null or blank for the shorted invoices")
        nul_res = validate_data(general_logger,error_logger,'PO\models\RCA11\RCA11.json',0,None,False,8,error_records_folder_name)
        general_logger.info("Validationg : LF_Short_code matches Short_Code in Billing Model")
        shortcode_res = validate_data(general_logger,error_logger,'PO\models\RCA11\RCA11.json',1,None,True,8,error_records_folder_name)
