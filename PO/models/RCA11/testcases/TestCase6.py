...
def exec_testcase_6():
    try:
        ...
        error_records_folder_name=rf'PO\models\RCA11\error_records\TESTCASE6\{timestamp}'
        res = validate_data(general_logger,error_logger,'PO\models\RCA11\RCA11.json',0,None,True,6,error_records_folder_name)
        if res:
