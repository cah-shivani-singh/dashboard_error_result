...
def exec_testcase_5():
    try:
        ...
        error_records_folder_name=rf'PO\models\RCA11\error_records\TESTCASE5\{timestamp}'
        res = validate_data(general_logger,error_logger,'PO\models\RCA11\RCA11.json',0,None,True,5,error_records_folder_name)
        if res:
