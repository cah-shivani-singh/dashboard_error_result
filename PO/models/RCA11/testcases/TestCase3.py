...
def exec_testcase_3():
    try:
        ...
        error_records_folder_name=rf'PO\models\RCA11\error_records\TESTCASE3\{timestamp}'
        res = validate_data(general_logger,error_logger,'PO\models\RCA11\RCA11.json',0,None,True,3,error_records_folder_name)
        if res:
