...
folder_path=rf'PO\models\RCA11\log_info\{timestamp}'
...
def collect_test_functions(function_list):
    ...
    for test_case_file in test_case_files:
        module_name = f'models.RCA11.testcases.{test_case_file[:-3]}'
        try:
...
if __name__ == "__main__":
    ...
    set_json_path(r'PO\\models\\RCA11\\rca11.json',general_logger,error_logger)
    #write_config()
