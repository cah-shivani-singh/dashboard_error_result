...
def exec_testcase_3():
    try:
        ...
        error_records_folder_name=rf'PO\models\RCA1\error_records\TESTCASE3\{timestamp}'
        res = validate_data(general_logger,error_logger,'PO\models\RCA1\RCA1.json',0,None,True,3,error_records_folder_name)
        if res:
