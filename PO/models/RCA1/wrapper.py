...
from po_utils.set_process_date import write_config,set_json_path

timestamp = datetime.now().strftime('%Y-%m-%d')
folder_path=rf'PO\models\RCA1\log_info\{timestamp}'
...
def collect_test_functions():
    ...
    for test_case_file in test_case_files:
        module_name = f'models.RCA1.testcases.{test_case_file[:-3]}'
        try:
...
if __name__ == "__main__":
    set_json_path(r'PO\\models\\RCA1\\RCA1.json',general_logger,error_logger)
    #write_config(general_logger,error_logger)
