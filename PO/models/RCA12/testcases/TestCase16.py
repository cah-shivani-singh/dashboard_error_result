...
def exec_testcase_16():
    try:
        ...
        error_records_folder_name=rf'PO\models\RCA12\error_records\TESTCASE16\{timestamp}'
        res = validate_data(general_logger,error_logger,'PO\models\RCA12\RCA12.json',0,None,True,16,error_records_folder_name)
        if res:
