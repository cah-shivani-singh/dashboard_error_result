...
def exec_testcase_10():
    try:
        ...
        error_records_folder_name=rf'PO\models\RCA12\error_records\TESTCASE10\{timestamp}'
        res = validate_data(general_logger,error_logger,'PO\models\RCA12\RCA12.json',0,None,True,10,error_records_folder_name)
        if res:
            increment_count('pass_tc_count',general_logger,error_logger)

    except Exception as e:
        general_logger.info("Error executing Validation for TestCase - 010, check error log file for more details")
