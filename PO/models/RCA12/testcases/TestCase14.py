...
def exec_testcase_14():
    try:
        ...
        error_records_folder_name=rf'PO\models\RCA12\error_records\TESTCASE14\{timestamp}'
        res = validate_data(general_logger,error_logger,'PO\models\RCA12\RCA12.json',0,None,True,14,error_records_folder_name)
        if res:
